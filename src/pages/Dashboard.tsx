...
export const Dashboard = () => {
  ...
  const availableRecipientOptions = deliveryMethod === 'SYSTEM'
    ? allRecipientOptions.filter(opt => opt.value === 'EDUCATOR' || opt.value === '')
    : allRecipientOptions;
  ...
  return (
    <div className="flex pb-14 md:pb-0">
      ...
      <div className="w-full p-4 md:ms-14 md:p-8">
        ...
        {isAdmin && (
          <form onSubmit={submitHandler} className="p-6 mt-4 bg-white rounded-md flex flex-col gap-6">
            <H2>Novo Aviso</H2>
            ...
            <div className="flex w-full flex-col items-end gap-4 md:flex-row md:items-center md:justify-between mt-2">
                <Button 
                  type="button"
        ...
        <div className="flex bg-white w-full rounded-md mt-4">
