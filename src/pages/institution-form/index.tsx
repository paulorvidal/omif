...
function InstitutionForm() {
  const { register, errors, handleFormSubmit, handleReset, isSubmitting } =
  ...
  return (
    <>
      <div className="flex items-center gap-4">
        ...
        <h1 className="text-3xl font-semibold">Cadastro da Instituição</h1>
      </div>
      ...
      <Card>
        <CardContent>
          <form onSubmit={handleFormSubmit} noValidate>
            <FieldGroup>
              <FieldSet>
                <FieldGroup className="gap-y-4 md:grid md:grid-cols-2 md:gap-x-6">
