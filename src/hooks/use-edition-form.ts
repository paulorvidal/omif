...
const EditionFormSchema = z
  .object({
    ...
    minimumWage: z
      .string({ required_error: "O salário mínimo é obrigatório" })
    ...
    institutionRegistrationStartDate: z
      .string()
      .nonempty("A data de início para instituições é obrigatória"),
    institutionRegistrationEndDate: z
      .string()
      .nonempty("A data de fim para instituições é obrigatória"),
    studentRegistrationStartDate: z
      .string()
      .nonempty("A data de início para estudantes é obrigatória"),
    studentRegistrationEndDate: z
      .string()
      .nonempty("A data de fim para estudantes é obrigatória"),
  })
  ...
  .refine(
    (data) =>
      new Date(data.institutionRegistrationEndDate) >
      new Date(data.institutionRegistrationStartDate),
    {
  ...
  .refine(
    (data) =>
      new Date(data.studentRegistrationEndDate) >
      new Date(data.studentRegistrationStartDate),
    {
  ...
  .refine(
    ...
    {
      message:
        "O início da inscrição de instituições deve ser igual ou posterior ao início da edição.",
      path: ["institutionRegistrationStartDate"],
    },
  )
  .refine(
    (data) =>
      new Date(data.institutionRegistrationEndDate) <= new Date(data.endDate),
    {
      message:
        "O fim da inscrição de instituições deve ser igual ou anterior ao fim da edição.",
      path: ["institutionRegistrationEndDate"],
    },
  )
  .refine(
    (data) =>
      new Date(data.studentRegistrationStartDate) >= new Date(data.startDate),
    {
      message:
        "O início da inscrição de estudantes deve ser igual ou posterior ao início da edição.",
      path: ["studentRegistrationStartDate"],
    },
  )
  .refine(
    (data) =>
      new Date(data.studentRegistrationEndDate) <= new Date(data.endDate),
    {
      message:
        "O fim da inscrição de estudantes deve ser igual ou anterior ao fim da edição.",
      path: ["studentRegistrationEndDate"],
    },
  )
  .refine(
    ...
    {
      message:
        "O início da inscrição de estudantes deve ser igual ou posterior ao fim da inscrição de instituições.",
      path: ["studentRegistrationStartDate"],
    },
  );
...
export const useEditionForm = ({ editionId }: UseEditionFormProps) => {
  ...
  useEffect(() => {
    if (editionData) {
      ...
      reset({
        ...
        institutionRegistrationStartDate: formatDateForInput(
          editionData.institutionRegistrationStartDate,
        ),
        institutionRegistrationEndDate: formatDateForInput(
          editionData.institutionRegistrationEndDate,
        ),
        studentRegistrationStartDate: formatDateForInput(
          editionData.studentRegistrationStartDate,
        ),
        studentRegistrationEndDate: formatDateForInput(
          editionData.studentRegistrationEndDate,
        ),
      });
    }
  }, [editionData, reset]);
  ...
  const { mutate, isPending } = useMutation({
    mutationFn: (
      requestData: CreateEditionRequest | Partial<UpdateEditionRequest>,
    ) => {
      if (isEditMode) {
    ...
    onError: (error) =>
      showToast(
        error instanceof ApiError ? error.message : "Falha na requisição.",
        "error",
      ),
  });
    ...
    if (isEditMode) {
      ...
      const payload: CreateEditionRequest = {
        ...
        institutionRegistrationStartDate: new Date(
          data.institutionRegistrationStartDate,
        ).toISOString(),
        institutionRegistrationEndDate: new Date(
          data.institutionRegistrationEndDate,
        ).toISOString(),
        studentRegistrationStartDate: new Date(
          data.studentRegistrationStartDate,
        ).toISOString(),
        studentRegistrationEndDate: new Date(
          data.studentRegistrationEndDate,
        ).toISOString(),
      };
      mutate(payload);
    }
